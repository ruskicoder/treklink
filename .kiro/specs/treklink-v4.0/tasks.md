...
- [ ] 1. Create `treklink_v4_supreme` overlay directory and files
...
- [ ] 2. Create `treklink-v4-supreme` PlatformIO environment
...
- [ ] 3. Implement `QMI8658FallSensor` adapter
...
- [ ] 4. Wire QMI8658 sensor in `Modules.cpp`
